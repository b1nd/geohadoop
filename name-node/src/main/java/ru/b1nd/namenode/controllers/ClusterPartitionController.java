...
public class ClusterPartitionController {
    ...
    private final Logger logger = LoggerFactory.getLogger(ClusterPartitionController.class);

    private final ClusterFileService clusterFileService;

    @Autowired
    public ClusterPartitionController(ClusterFileService clusterFileService) {
